...
StreamDeck have its own [icons store](https://apps.elgato.com/icons), with many (free packs to choose from. It's very simple to use and intuitive to set up. We spread the button over the grid to
