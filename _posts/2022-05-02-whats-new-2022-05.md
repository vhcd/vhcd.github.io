...
The new release includes an [OpenSCENARIO](/scenarios/#openscenario)-compliant [Scenario Editor](https://mathworks.com/products/roadrunner-scenario.html), which I don't think will be of any use to us, as we [author scenarios](/scenario-authoring) straight in Unreal.
