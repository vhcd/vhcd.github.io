...
I also worked on automation, to make sure everything runs fine, to give the experimenter feedback about any potential issue, to backup and move all recordings to their appropriate locations, etc.
...
Some minor things that are intersting but don't deserve their own sections.
