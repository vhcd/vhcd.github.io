...
September was the annual time for the [Driving Simulation Conference](https://dsc2021.org/) (DSC). I was really looking forward to Epic's keynote (Sébastien Lozé), but it was mostly rehashed content from [Unreal Build: Automotive 2021](https://www.unrealengine.com/en-US/events/unreal-build-automotive-2021), with some  Metaverse added on top. So no real news on the Epic front.
