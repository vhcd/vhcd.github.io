...
On a side note, as a tool developer, I just love being able to watch people use those tools. It gives instant feedback into what could be done better. For example, after having accidently lost a week's worth of hand-placed road decals, the ability to [proceduraly place them](https://twitter.com/brifsttar/status/1547114742195560448), using OpenDRIVE data, was a nice way to make up for the loss.
