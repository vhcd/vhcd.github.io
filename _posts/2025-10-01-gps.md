...
For an ongoing research project, we're making a fairly realistic GPS app to be used in a full-size driving simulator. It's all done within Unreal, so let's explore how we did that.
...
As with real navigation apps, the camera properties (e.g., location, field of view) change depending on Ego speed, and maybe also other events.
