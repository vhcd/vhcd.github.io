...
World Partition is mostly targeting open world development, which when you think about it, is not really our use case. In most of our experiment, we know exactly the itineray the participant will follow, and we can build our whole environments around that. We can divide our sublevels around our scenario, load and unload them at strategic points in the simulation, and so on.
