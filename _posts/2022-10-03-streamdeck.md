...
The application that immediately came to mind was what I'd call an "[Experimenter Deck](/worfklow-2/#streamdeck)".
...
During an actual experiment, the researcher is in the control room and therefore has access to all safety features (on their [Experimenter Deck](/streamdeck/#experimenter-deck)!) that act as an "Emergency Soft Stop", such as:
